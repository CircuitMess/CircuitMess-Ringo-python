...
i2c = I2C(scl=Pin(27), sda=Pin(14), freq=100000)
buttons = PCF8574.PCF8574(i2c, 0x21) #21 for main buttons, 20 for numerical keypad
spi = SPI(2, baudrate=20000000, polarity=0, phase=0, sck=Pin(18), mosi=Pin(23), miso=Pin(19))
display=TFT(spi,0,2,4)
display.initr()
display.rgb(True)
while (1):
    for a in range(7):
        print(buttons.read(buttons.BTN_A), end='')
    print()